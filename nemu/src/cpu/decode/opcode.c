...
instr_func opcode_entry[256] = {
    ...
    /* 0x40 - 0x43*/ inc_a_l, inc_c_l, inc_d_l, inc_b_l,
    /* 0x44 - 0x47*/ inc_esp, inc_ebp, inc_esi, inc_edi,
    /* 0x48 - 0x4b*/ dec_a_l, dec_c_l, dec_d_l, dec_b_l,
    ...
    /* 0xe8 - 0xeb*/ call_near, jmp_near, jmp_far_imm, jmp_b,
...
instr_func group_1_b_entry[8] =
    {inv, inv, inv, inv, and_i2rm_b, sub_i2rm_b, inv, cmp_i2rm_b};
